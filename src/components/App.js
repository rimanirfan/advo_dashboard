...
class App extends React.Component {
    ...
    state = {
        ...
        productsY: [
            {id: 1, name: 'HausHaus Hijau', price: '5000', sold: 10},
            {id: 2, name: 'HausHaus Merah', price: '3000', sold: 4},
            {id: 3, name: 'HausHaus Biru', price: '5200', sold: 3},
            {id: 4, name: 'HausHaus Putih', price: '8000', sold: 5},
            {id: 5, name: 'HausHaus Pink', price: '10000', sold: 19},
        ],
        competitorsY: [
            {id: 1, name: 'HausHaus Hijau', price: '5000', sold: 10},
            {id: 2, name: 'HausHaus Merah', price: '3000', sold: 4},
    ...
    setChartData() {
        if (this.state.showYesterday) return this.state.chartDataY
        else return this.state.chartData
    };

    onApplyFilter = (date, from, to) => {
        this.setState({filter: date, showYesterday: !this.state.showYesterday});
    };
            ...
            <div>
                ...
                <div className="flex">
                    ...
                    <div className="flex_item_nine content">
                        {this.state.showModal && <div className="modal_bg" onClick={this.triggerPeriodModal}></div>}
                        ...
                        <div className="flex">
                            <div className="flex_item_five">
                                <Chart data={this.setChartData()} dots={dots} />
                            </div>
                            <div className="flex_item_five">
                                <div className="flex">
                                    <div className="flex_item_five">
                                        <BestSelling products={this.state.showYesterday ? this.state.productsY : this.state.products} dots={dots} />
                                    </div>
                                    <div className="flex_item_five">
                                        <TopCompetitor competitors={this.state.showYesterday ? this.state.competitorsY : this.state.competitors} dots={dots} />
                                    </div>
                                </div>
                            </div>
                        </div>
